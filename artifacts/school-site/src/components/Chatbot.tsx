...
export function Chatbot() {
  ...
  return (
    <div className="fixed bottom-4 left-6 z-[100] flex flex-col items-start">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            key="chatwindow"
            ...
            className="mb-3 w-80 bg-white rounded-2xl overflow-hidden shadow-2xl"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-[11px]">Anglo Sanskrit School · AI</p>
                </div>
              </div>
                  ...
                  >
                    <div
                      className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mb-0.5 ${
                        msg.role === "user" ? "bg-violet-100" : "bg-violet-600"
                      }`}
                    >
                      {msg.role === "user" ? (
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="flex items-end gap-1.5">
                    <div className="w-6 h-6 rounded-full bg-violet-600 flex items-center justify-center mb-0.5">
                      <Bot className="w-3 h-3 text-white" />
                    </div>
